...
class WhatsApp:
    ...
    def nav_green_dot(self):
        try:
            position = pt.locateOnScreen('C:\\Users\\KIIT\\PycharmProjects\\firstProg\\whatsapp automation\\green dot.png', confidence=.7)
    ...
    def nav_input_box(self):
        try:
            position = pt.locateOnScreen('C:\\Users\KIIT\\PycharmProjects\\firstProg\\whatsapp automation\\smiley_paperclip.png', confidence=.7)
            pt.moveTo(position[0:2], duration=self.speed)
